...
public class ProblemActivity extends BaseActivity implements OnClickListener {
	...
	private void initview() {
		...
		title1 = (TextView) findViewById(R.id.problem_title_tv1);
		title2 = (TextView) findViewById(R.id.problem_title_tv2);
		title1.setOnClickListener(this);
		title2.setOnClickListener(this);
		getviewdate();

		pager=(ViewPager) findViewById(R.id.problem_viewpagers);
	...
	private void getviewdate(){
		...
		view2.setText(R.string.problem_str2);
		views.add(view2);
	}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case R.id.problem_title_tv1:
			changtitleTv(title1,title2,0);
			break;
		case R.id.problem_title_tv2:
			changtitleTv(title1,title2,1);
			break;
